...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="?page=movie_create" type="button" class="btn btn-sm btn-outline-secondary">Tambah Baru</a>
        <a href="?page=movie_chart" type="button" class="btn btn-sm btn-outline-secondary">Chart</a>
    ...
    <?php
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<tr> 
                ...
                <td>".$row['judul_movie']."<br /><br />Genre: <strong>".$row['genre']."</strong></td>
                <td>".$row['tahun']."</td>
                <td>".$row['deskripsi']."</td>
                <td> 
                    ".implode(" ",$btn)."
